...
export function createApp() {
  ...
  try {
    ...
    console.warn(`[origo-backend] SQLite unavailable; customer portal bridge will stay online without local admin DB. ${message}`);
  }
  ...
  registerHealthRoute(app, { nowIso, sqliteAvailable });
